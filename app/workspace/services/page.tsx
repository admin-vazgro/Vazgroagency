    ...
    <div className="p-8">
      ...
      {!accountId ? (
        <div className="border border-dashed border-[var(--portal-border-strong)] p-12 text-center">
          <p className="font-ibm-mono text-[14px] text-[var(--portal-text-soft)]">No services yet.</p>
          <p className="mt-2 font-ibm-mono text-[14px] leading-[1.7] text-[var(--portal-text-dim)]">
            Your active services will appear here once your account is set up.
          </p>
          <Link
            href="/services"
            className="mt-6 inline-flex items-center justify-center h-[44px] px-8 bg-[var(--portal-accent)] font-ibm-mono text-[14px] tracking-[2px] text-[var(--portal-accent-contrast)]"
          >
            EXPLORE SERVICES →
          </Link>
        </div>
        ...
        <div className="flex flex-col gap-10">
          ...
          {growPlans.length > 0 && (
            <section>
              <h2 className="mb-4 font-ibm-mono text-[14px] tracking-[2px] text-[var(--portal-warning)]">GROW — MONTHLY SUBSCRIPTIONS</h2>
                  ...
                  <div key={eng.id} className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-6">
                    <div className="mb-4 flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-0.5 font-ibm-mono text-[14px] text-[var(--portal-text-soft)]">{pillarDescriptions.GROW}</p>
                      </div>
                      <span
                    ...
                    <div className="grid grid-cols-3 gap-3 border-t border-[var(--portal-border)] pt-4">
                      <div>
                        <p className="font-ibm-mono text-[14px] tracking-[1px] text-[var(--portal-text-dim)]">MRR</p>
                        <p className="mt-1 font-grotesk text-[18px] font-normal text-[var(--portal-warning)]">
                          £{toNumber(eng.monthly_value_gbp).toLocaleString()}<span className="font-ibm-mono text-[14px] text-[var(--portal-text-dim)]">/mo</span>
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        <p className="font-ibm-mono text-[14px] tracking-[1px] text-[var(--portal-text-dim)]">BILLING</p>
                        <p className="mt-1 font-ibm-mono text-[14px] text-[var(--portal-text-muted)]">Monthly</p>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          {launchPackages.length > 0 && (
            <section>
              <h2 className="mb-4 font-ibm-mono text-[14px] tracking-[2px] text-[var(--portal-accent)]">LAUNCH — ONE-OFF PACKAGES</h2>
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                {launchPackages.map((eng) => (
                  <div key={eng.id} className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-6">
                    <div className="mb-4 flex items-start justify-between gap-3">
                      <div>
                        <p className="font-grotesk text-[16px] font-normal text-[var(--portal-text)]">{eng.title}</p>
                        <p className="mt-0.5 font-ibm-mono text-[14px] text-[var(--portal-text-soft)]">{pillarDescriptions.LAUNCH}</p>
                      </div>
                      <span
                        className="shrink-0 px-2 py-1 font-ibm-mono text-[14px] tracking-[1px]"
                    ...
                    <div className="grid grid-cols-2 gap-3 border-t border-[var(--portal-border)] pt-4">
                      <div>
                        <p className="font-ibm-mono text-[14px] tracking-[1px] text-[var(--portal-text-dim)]">CONTRACT VALUE</p>
          ...
          {buildProjects.length > 0 && (
            <section>
              <h2 className="mb-4 font-ibm-mono text-[14px] tracking-[2px] text-[var(--portal-text-soft)]">BUILD — CUSTOM PROJECTS</h2>
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                {buildProjects.map((eng) => (
                  <div key={eng.id} className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-6">
                    <div className="mb-4 flex items-start justify-between gap-3">
                      <div>
                        <p className="font-grotesk text-[16px] font-normal text-[var(--portal-text)]">{eng.title}</p>
                        <p className="mt-0.5 font-ibm-mono text-[14px] text-[var(--portal-text-soft)]">{pillarDescriptions.BUILD}</p>
                      </div>
                      <span
                        className="shrink-0 px-2 py-1 font-ibm-mono text-[14px] tracking-[1px]"
                    ...
                    <div className="grid grid-cols-2 gap-3 border-t border-[var(--portal-border)] pt-4">
                      ...
                      <div>
                        <p className="font-ibm-mono text-[14px] tracking-[1px] text-[var(--portal-text-dim)]">EXPECTED END</p>
                        <p className="mt-1 font-ibm-mono text-[14px] text-[var(--portal-text-muted)]">
          ...
          {activeEngagements.length === 0 && (
            <div className="border border-dashed border-[var(--portal-border-strong)] p-12 text-center">
              <p className="font-ibm-mono text-[14px] text-[var(--portal-text-soft)]">No active services yet.</p>
              <p className="mt-2 font-ibm-mono text-[14px] leading-[1.7] text-[var(--portal-text-dim)]">
          ...
          <section className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-6">
            <p className="font-ibm-mono text-[14px] tracking-[2px] text-[var(--portal-text-muted)] mb-4">ADD A SERVICE</p>
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
              {[
                ...
                >
                  <div>
                    <p className="font-ibm-mono text-[14px] tracking-[1.5px]" style={{ color: pillarColors[item.pillar] }}>
                      {item.label}
                    </p>
                    <p className="mt-1 font-ibm-mono text-[14px] text-[var(--portal-text-dim)]">{item.desc}</p>
                  </div>
          ...
          <div className="flex items-center justify-between border border-[var(--portal-border)] bg-[var(--portal-surface)] p-5">
            <p className="font-ibm-mono text-[14px] text-[var(--portal-text-soft)]">View invoices, payment methods, and download receipts.</p>
            <Link
              href="/workspace/billing"
              className="shrink-0 font-ibm-mono text-[14px] tracking-[1.5px] text-[var(--portal-accent)] hover:opacity-80 transition-opacity"
            >
              BILLING & INVOICES →
            </Link>
          </div>
