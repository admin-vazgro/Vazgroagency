    ...
    <div className="flex flex-col h-full">
      ...
      <div className="border-b border-[var(--portal-border)] bg-[var(--portal-surface)] px-8 py-5">
        <div className="mb-2 flex items-center gap-2">
          <Link href="/hub/engagements" className="font-ibm-mono text-[10px] text-[var(--portal-text-dim)] hover:text-[var(--portal-text-soft)] transition-colors">
            ← Engagements
          </Link>
          <span className="font-ibm-mono text-[10px] text-[var(--portal-text-dim)]">/</span>
          <span className="font-ibm-mono text-[10px] text-[var(--portal-text-muted)]">{eng.title}</span>
        </div>
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="flex flex-wrap items-center gap-3 mb-1">
              <span className="font-ibm-mono text-[11px] tracking-[2px]" style={{ color: pillarColors[eng.pillar] }}>{eng.pillar}</span>
              <span
            ...
            <p className="mt-1 font-ibm-mono text-[11px] text-[var(--portal-text-soft)]">
              {account?.name ?? "—"} · {daysRunning} days running · {pm ? displayProfileName(pm) + " (PM)" : "No PM assigned"}
            </p>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="font-ibm-mono text-[9px] tracking-[1px] text-[var(--portal-text-dim)]">{eng.pillar === "GROW" ? "MRR" : "VALUE"}</p>
              <p className="font-grotesk text-[22px] font-normal text-[var(--portal-accent)]">
                £{value.toLocaleString()}<span className="font-ibm-mono text-[11px] text-[var(--portal-text-dim)]">{valueLabel}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 flex gap-0 border-b border-[var(--portal-border)] -mb-[1px]">
          {tabs.map((tab) => (
            <Link
              ...
              className="px-5 py-2.5 font-ibm-mono text-[10px] tracking-[1px] transition-colors border-b-2"
              style={{
      ...
      <div className="flex-1 overflow-auto p-8">
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-[2fr_1fr]">
            <div className="flex flex-col gap-6">
              ...
              <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-6">
                <p className="mb-3 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">PROJECT BRIEF</p>
                <p className="font-ibm-mono text-[12px] leading-[1.8] text-[var(--portal-text-soft)]">
              ...
              <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)]">
                <div className="border-b border-[var(--portal-border)] px-6 py-4">
                  <p className="font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">MILESTONES</p>
                </div>
                {milestones.length ? (
                  milestones.map((m: { id: string; title: string; due_date: string | null; completed_at: string | null; amount_gbp: number | null }) => (
                    <div key={m.id} className="flex items-center justify-between gap-4 border-b border-[var(--portal-border)] px-6 py-4 last:border-b-0">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <p className="font-ibm-mono text-[11px] text-[var(--portal-text)]">{m.title}</p>
                          {m.due_date && (
                      ...
                      {m.amount_gbp && (
                        <span className="font-ibm-mono text-[11px] text-[var(--portal-text-muted)]">
                  ...
                  <div className="px-6 py-8">
                    <p className="font-ibm-mono text-[11px] text-[var(--portal-text-soft)]">No milestones yet.</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-5">
                <p className="mb-3 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">KEY DATES</p>
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <div key={label} className="flex items-center justify-between">
                      ...
                      <span className="font-ibm-mono text-[11px] text-[var(--portal-text-muted)]">{val}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-5">
                <p className="mb-3 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">STATS</p>
                <div className="flex flex-col gap-3">
                  {[
              ...
              <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-5">
                <p className="mb-3 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">QUICK ACTIONS</p>
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    <Link
                      ...
                      className="block border border-[var(--portal-border)] bg-[var(--portal-bg)] px-4 py-3 font-ibm-mono text-[10px] tracking-[1px] text-[var(--portal-text-muted)] transition-colors hover:border-[var(--portal-accent)] hover:text-[var(--portal-accent)]"
                    >
                      {action.label}
                    </Link>
                  ))}
        ...
        {activeTab === "tasks" && (
          <div>
            <div className="mb-6 flex items-center justify-between">
              <h2 className="font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">TASK BOARD</h2>
              <span className="font-ibm-mono text-[10px] text-[var(--portal-text-dim)]">{requests.length} total requests</span>
            </div>
                ...
                return (
                  <div key={col.key} className="flex-shrink-0 w-[260px]">
                    <div className="mb-3 flex items-center justify-between">
                      <span className="font-ibm-mono text-[10px] tracking-[1px] text-[var(--portal-text-muted)]">{col.label.toUpperCase()}</span>
                      <span
                        className="flex h-5 w-5 items-center justify-center font-ibm-mono text-[9px]"
                    ...
                    <div className="flex flex-col gap-2">
                      {colRequests.map((req: { id: string; title: string; status: string; created_at: string; description: string | null }) => {
                        ...
                        return (
                          ...
                          >
                            <p className="font-ibm-mono text-[11px] text-[var(--portal-text)] leading-[1.5]">{req.title}</p>
                            {req.description && (
                              <p className="mt-1 font-ibm-mono text-[10px] text-[var(--portal-text-dim)] leading-[1.5] line-clamp-2">{req.description}</p>
                            )}
                      ...
                      {colRequests.length === 0 && (
                        <div className="border border-dashed border-[var(--portal-border)] p-4">
                          <p className="font-ibm-mono text-[10px] text-[var(--portal-text-dim)]">Empty</p>
                        </div>
                      )}
                    </div>
                  </div>
        ...
        {activeTab === "files" && (
          <div>
            <div className="mb-6 flex items-center justify-between">
              <h2 className="font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">DELIVERABLES & FILES</h2>
              <span className="font-ibm-mono text-[10px] text-[var(--portal-text-dim)]">{deliverables.length} files</span>
            </div>
            <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)]">
              ...
              {deliverables.length ? deliverables.map((d: { id: string; name: string; file_url: string | null; file_type: string | null; requires_approval: boolean; approved_at: string | null; created_at: string }) => (
                <div key={d.id} className="grid grid-cols-[1fr_100px_120px_100px] gap-4 items-center border-b border-[var(--portal-border)] px-5 py-4 hover:bg-[var(--portal-surface-alt)] last:border-b-0">
                  <div>
                    ...
                    {d.file_url && (
                      <a href={d.file_url} target="_blank" rel="noopener noreferrer" className="font-ibm-mono text-[10px] text-[var(--portal-accent)] hover:opacity-80">
                        Download ↓
                      </a>
                    )}
                  </div>
                ...
                <div className="px-5 py-10">
                  <p className="font-ibm-mono text-[11px] text-[var(--portal-text-soft)]">No files yet.</p>
                </div>
              )}
            </div>
          </div>
        ...
        {activeTab === "team" && (
          <div>
            <h2 className="mb-6 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">PROJECT TEAM</h2>
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              {pm && (
                <div className="border border-[var(--portal-accent)] bg-[var(--portal-surface)] p-5">
                  <p className="mb-3 font-ibm-mono text-[9px] tracking-[1.5px] text-[var(--portal-accent)]">PROJECT MANAGER</p>
                  <p className="font-grotesk text-[16px] font-normal text-[var(--portal-text)]">{displayProfileName(pm)}</p>
                  <p className="mt-1 font-ibm-mono text-[10px] text-[var(--portal-text-muted)]">{pm.email}</p>
                </div>
              )}
              {team.map((member: { id: string; profile_id: string; role: string }) => {
                ...
                return (
                  <div key={member.id} className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-5">
                    <p className="mb-3 font-ibm-mono text-[9px] tracking-[1.5px] text-[var(--portal-text-dim)]">{member.role.toUpperCase()}</p>
                    <p className="font-grotesk text-[16px] font-normal text-[var(--portal-text)]">{displayProfileName(profile)}</p>
                    <p className="mt-1 font-ibm-mono text-[10px] text-[var(--portal-text-muted)]">{profile.email}</p>
                  </div>
                );
              })}
              {!pm && team.length === 0 && (
                <div className="border border-dashed border-[var(--portal-border-strong)] p-8">
                  ...
                  <Link href="/hub/admin" className="mt-2 block font-ibm-mono text-[10px] text-[var(--portal-accent)]">Assign via Admin →</Link>
                </div>
              )}
            </div>
          </div>
        ...
        {activeTab === "activity" && (
          <div>
            <h2 className="mb-6 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">ACTIVITY TIMELINE</h2>
            {activities.length ? (
              <div className="flex flex-col gap-0 border-l-2 border-[var(--portal-border)] ml-2">
                {activities.map((act: { id: string; type: string; subject: string | null; body: string | null; created_at: string }) => (
                  <div key={act.id} className="relative pl-6 pb-5">
                    ...
                    <p className="mt-1 font-ibm-mono text-[11px] text-[var(--portal-text)]">{act.type.replace(/_/g, " ")}</p>
                    {act.subject && <p className="mt-0.5 font-ibm-mono text-[10px] text-[var(--portal-text-muted)]">{act.subject}</p>}
                  </div>
                ))}
              </div>
            ) : (
              <p className="font-ibm-mono text-[11px] text-[var(--portal-text-soft)]">No activity logged yet.</p>
            )}
          </div>
        )}
        ...
        {activeTab === "billing" && (
          <div>
            <h2 className="mb-6 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">BILLING & INVOICES</h2>
            {eng.stripe_subscription_id && (
              <div className="mb-6 border border-[var(--portal-accent)] bg-[var(--portal-accent-soft)] px-5 py-4">
                <p className="font-ibm-mono text-[11px] text-[var(--portal-accent)]">GROW Subscription Active</p>
                <p className="mt-1 font-ibm-mono text-[10px] text-[var(--portal-text-muted)]">Stripe Subscription ID: {eng.stripe_subscription_id}</p>
              </div>
            )}
              ...
              <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)]">
                ...
                {(invoices as Array<{ id: string; title: string; amount_gbp: number | string; status: string; due_date: string | null; paid_at: string | null; created_at: string }>).map((inv) => (
                  <div key={inv.id} className="grid grid-cols-[1fr_100px_120px_100px] gap-4 items-center border-b border-[var(--portal-border)] px-5 py-4 hover:bg-[var(--portal-surface-alt)] last:border-b-0">
                    ...
                    <span className="font-ibm-mono text-[11px] text-[var(--portal-text-muted)]">£{toNumber(inv.amount_gbp).toLocaleString()}</span>
                    <span className="font-ibm-mono text-[10px] text-[var(--portal-text-muted)]">{inv.due_date ? new Date(inv.due_date).toLocaleDateString("en-GB") : "—"}</span>
                    <span className="font-ibm-mono text-[10px] text-[var(--portal-accent)]">{inv.status.toUpperCase()}</span>
                  </div>
                ))}
              </div>
            ) : (
              <p className="font-ibm-mono text-[11px] text-[var(--portal-text-soft)]">No invoices for this engagement.</p>
            )}
          </div>
        )}
        ...
        {activeTab === "notes" && (
          <div>
            <h2 className="mb-6 font-ibm-mono text-[10px] tracking-[2px] text-[var(--portal-text-muted)]">INTERNAL NOTES</h2>
            <div className="border border-[var(--portal-border)] bg-[var(--portal-surface)] p-6">
