  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#0A0A0A] px-6 py-16">
      <div className="w-full max-w-[520px] border border-[#2D2D2D] bg-[#0F0F0F] p-10 text-center">
        ...
        <span className="font-ibm-mono text-[10px] tracking-[3px] text-[#D6E264]">
          // PAYMENT CONFIRMED
        </span>
        ...
        <p className="mt-4 font-ibm-mono text-[12px] leading-[1.8] tracking-[0.5px] text-[#BBBBBB]">
        ...
        <div className="mt-8 flex flex-col gap-[2px]">
          {[
            ...
            <div key={n} className="flex items-center gap-3 p-4 bg-[#0A0A0A] border border-[#1D1D1D]">
              <span className="font-ibm-mono text-[11px] text-[#D6E264] shrink-0">{n}</span>
              <span className="font-ibm-mono text-[11px] text-[#CCCCCC] tracking-[0.3px]">{text}</span>
            </div>
          ))}
        </div>

        <p className="mt-6 font-ibm-mono text-[11px] text-[#AAAAAA] leading-[1.7]">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/login"
            className="flex-1 flex items-center justify-center h-[48px] bg-[#D6E264] hover:bg-[#c9d64f] transition-colors font-grotesk text-[11px] font-bold text-[#0A0A0A] tracking-[2px]"
          >
            SIGN IN TO WORKSPACE
          </Link>
          <Link
            href="/"
            className="flex-1 flex items-center justify-center h-[48px] border border-[#2D2D2D] bg-[#111111] hover:border-[#555] transition-colors font-ibm-mono text-[10px] text-[#AAAAAA] tracking-[1.5px]"
          >
            BACK TO HOME
          </Link>
        </div>
