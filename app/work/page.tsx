  ...
  return (
    <main className="flex flex-col w-full bg-[#0A0A0A] pt-[60px]">
            ...
            <div className="flex flex-col justify-between flex-1">
              <div>
                <div className="mb-5 flex flex-wrap items-center gap-3">
                  ...
                  <span className="font-ibm-mono text-[10px] text-[#999999] tracking-[2px]">{p.year}</span>
                </div>
                <h2 className="font-grotesk text-[36px] md:text-[48px] font-normal text-[#F5F5F0] tracking-[-2px] leading-none mb-3">
                  {p.title}
                </h2>
                <p className="font-ibm-mono text-[12px] text-[#FFFFFF] tracking-[1px] leading-[1.6] mb-6 max-w-[480px]">
                  {p.description}
                </p>
                <div className="flex flex-wrap gap-[2px]">
                  {p.outcomes.map((o) => (
                    <span key={o} className="font-ibm-mono text-[10px] text-[#AAAAAA] tracking-[1px] bg-[#1A1A1A] border border-[#2D2D2D] px-3 py-1.5">
                      + {o}
                    </span>
                  ))}
                </div>
      ...
      <section className="flex flex-col items-center text-center w-full px-6 md:px-[120px] py-16 md:py-[80px] border-t border-[#1D1D1D]">
        <span className="font-ibm-mono text-[11px] font-normal text-[#D6E264] tracking-[3px] mb-4">// HAVE A PROJECT IN MIND?</span>
