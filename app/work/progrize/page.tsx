    ...
    <main className="flex flex-col w-full bg-white pt-[60px]">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          <div className="flex-1">
            <div className="mb-6 flex flex-wrap items-center gap-3">
              <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] border border-[#D6E264] px-3 py-1 tracking-[2px]">
                [PRODUCT BUILD]
              </span>
            ...
            <h1 className="font-grotesk text-[56px] md:text-[96px] font-normal text-[#0A0A0A] tracking-[-4px] leading-none mb-6">
              PROGRIZE
            </h1>
          ...
          <div className="grid grid-cols-2 gap-[2px] w-full lg:w-[360px] shrink-0">
            {metrics.map((m) => (
              <div key={m.label} className="flex flex-col gap-2 p-6 bg-[#EFEFEF] border border-[#D8D8D8]">
                <span className="font-grotesk text-[40px] font-normal text-[#6B7800] tracking-[-2px] leading-none">{m.value}</span>
      ...
      <section className="w-full px-6 md:px-[120px] py-10">
        <div className="relative w-full overflow-hidden bg-[#EFEFEF] border border-[#D8D8D8]" style={{ aspectRatio: "16/7" }}>
          ...
          <div className="absolute bottom-6 left-8">
            <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] tracking-[2px]">// PROGRIZE APP — MOBILE SURFACE</span>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col lg:flex-row gap-12 w-full px-6 md:px-[120px] py-16 md:py-[80px] border-t border-[#E5E5E5]">
        <div className="w-full lg:w-[200px] shrink-0">
          <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] tracking-[3px]">// THE CHALLENGE</span>
        </div>
      ...
      <section className="flex flex-col w-full px-6 md:px-[120px] py-16 md:py-[80px] bg-[#F5F5F5] border-t border-b border-[#E5E5E5]">
        <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] tracking-[3px] mb-8">// USER RESEARCH FINDINGS</span>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[2px]">
          {researchInsights.map((r) => (
            <div key={r.stat} className="flex flex-col gap-4 p-8 bg-[#EFEFEF] border border-[#D8D8D8]">
              <span className="font-grotesk text-[56px] font-normal text-[#6B7800] tracking-[-3px] leading-none">{r.stat}</span>
      ...
      <section className="flex flex-col w-full px-6 md:px-[120px] py-16 md:py-[100px]">
        <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] tracking-[3px] mb-12">// DESIGN & BUILD PROCESS</span>
          ...
          {phases.map((phase) => (
            <div key={phase.num} className="flex flex-col lg:flex-row gap-8 p-8 md:p-[48px] bg-[#F5F5F5] border border-[#D8D8D8]">
              <div className="flex flex-col gap-2 w-full lg:w-[180px] shrink-0">
                <span className="font-grotesk text-[48px] font-normal text-[#6B7800] tracking-[-3px] leading-none">{phase.num}</span>
      ...
      <section className="flex flex-col w-full px-6 md:px-[120px] pb-16 md:pb-[80px] gap-[2px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[2px]">
          <div className="relative overflow-hidden bg-[#111] border border-[#D8D8D8]" style={{ aspectRatio: "16/9" }}>
            <Image src="/websiteprogrize.svg" alt="Progrize Web" fill className="object-cover" sizes="50vw" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent" />
            <div className="absolute bottom-4 left-4">
              <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] tracking-[2px]">// WEB PLATFORM</span>
            </div>
          </div>
          <div className="relative overflow-hidden bg-[#111] border border-[#D8D8D8]" style={{ aspectRatio: "16/9" }}>
      ...
      {/* ── Testimonial ── */}
      <section className="flex flex-col w-full px-6 md:px-[120px] py-16 md:py-[80px] bg-[#EFEFEF] border-t border-[#E5E5E5]">
        <div className="max-w-[800px]">
          <div className="w-[40px] h-[3px] bg-[#D6E264] mb-8" />
          <blockquote className="font-grotesk text-[28px] md:text-[40px] font-normal text-[#0A0A0A] tracking-[-1px] leading-[1.15] mb-8">
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-[48px] h-[48px] overflow-hidden rounded-full bg-[#E8E8E8] border border-[#D8D8D8]">
              <Image src="/AVATAR.svg" alt="George A." fill className="object-cover" sizes="48px" />
            </div>
            <div>
              <div className="font-grotesk text-[14px] font-normal text-[#0A0A0A] tracking-[0.5px]">GEORGE A.</div>
              <div className="font-ibm-mono text-[14px] text-[#666666] tracking-[2px]">FOUNDER, PROGRIZE</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col w-full px-6 md:px-[120px] py-16 md:py-[80px] border-t border-[#E5E5E5]">
        <span className="font-ibm-mono text-[14px] font-normal text-[#6B7800] tracking-[3px] mb-8">// OUTCOMES</span>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[2px]">
          {[
            ...
            <div key={o.title} className="flex flex-col gap-4 p-8 bg-[#EFEFEF] border border-[#D8D8D8]">
              <span className="font-grotesk text-[18px] font-normal text-[#6B7800] tracking-[0.5px]">{o.title}</span>
      ...
      <section className="flex flex-col items-center text-center w-full px-6 md:px-[120px] py-16 md:py-[80px] bg-[#D6E264]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          >
            <span className="font-grotesk text-[14px] font-normal text-[#6B7800] tracking-[2px]">
