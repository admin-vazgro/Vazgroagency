  ...
  return (
    <main className="flex flex-col w-full bg-[#0A0A0A] pt-[60px]">
      ...
      <section className="flex flex-col w-full py-16 px-6 md:py-[100px] md:px-[120px] border-b border-[#1D1D1D]">
        <span className="font-ibm-mono text-[11px] font-bold text-[#D6E264] tracking-[3px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[2px]">
          {filtered.map((pkg) => (
            ...
            >
              ...
              <div>
                <span className="font-ibm-mono text-[10px] text-[#999999] tracking-[2px]">{pkg.category.toUpperCase()}</span>
                <h2 className="font-grotesk text-[28px] font-bold text-[#F5F5F0] tracking-[-1px] leading-none mt-1">
                  {pkg.name}
                </h2>
                <p className="font-ibm-mono text-[11px] text-[#BBBBBB] tracking-[1px] leading-[1.6] mt-2">
                  {pkg.description}
                </p>
              </div>
      ...
      <section className="flex flex-col w-full px-6 md:px-[120px] py-16 md:py-[80px] border-t border-[#1D1D1D]">
        <span className="font-ibm-mono text-[11px] font-bold text-[#D6E264] tracking-[3px] mb-4">// FAQ</span>
        ...
        <div className="flex flex-col gap-[2px] max-w-[820px]">
          {faqs.map((faq) => (
            <div key={faq.q} className="flex flex-col gap-3 p-6 md:p-8 bg-[#0F0F0F] border border-[#2D2D2D]">
              ...
              <p className="font-ibm-mono text-[12px] text-[#BBBBBB] tracking-[0.5px] leading-[1.7]">{faq.a}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="flex flex-col items-center text-center w-full px-6 md:px-[120px] py-16 md:py-[80px] border-t border-[#1D1D1D] bg-[#0F0F0F]">
        <span className="font-ibm-mono text-[11px] font-bold text-[#D6E264] tracking-[3px] mb-4">// NOT SURE WHICH PACKAGE?</span>
