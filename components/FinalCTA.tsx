  ...
  return (
    <section className="flex flex-col items-center w-full bg-[#0A0A0A] py-16 px-6 md:px-8 md:py-[80px] lg:p-[120px] gap-10 md:gap-[48px] border-t-2 border-t-[#D6E264]">
      ...
      <div className="flex items-center justify-center gap-[8px] h-[32px] px-[16px] bg-[#1A1A1A] border-2 border-[#D6E264]">
        <span className="font-ibm-mono text-[14px] font-normal text-[#D6E264] tracking-[2px]">
      ...
      {/* Subtitle */}
      <p className="w-full max-w-[700px] px-2 text-center text-pretty font-ibm-mono text-[14px] md:text-[14px] text-[#BBBBBB] tracking-[0.3px] md:tracking-[2px] leading-[1.7]">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-[16px] w-full sm:w-auto">
        ...
        >
          <span className="text-center font-ibm-mono text-[14px] md:text-[14px] text-[#BBBBBB] tracking-[1.5px] md:tracking-[2px]">
            EMAIL US
          </span>
        </a>
      </div>

      <p className="max-w-[320px] text-center font-ibm-mono text-[14px] md:max-w-none md:text-[14px] text-[#999999] tracking-[1px] md:tracking-[2px] leading-[1.7]">
